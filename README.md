...
autonomic nervous system activity between the young and the elderly 
...
|---|---|---|---|
| Mean BPM | -0.802 | 0.433 | Not significant |
| RMSSD | -2.499 | 0.022 | * |
| SDNN | — | 0.003 | ** |
| pNN50 | — | <0.001 | *** |

## Key Findings
- Young adults show significantly higher HRV than the elderly 
